...
Q6. Write query to return the emial, first name, last name, & Genre of all rock music listeners. Return your list ordered alphabetically by email starting with	 A.
...
Q8. write a query to return the name and miliseconds for each track. Order by the song length with the longest songs listed first.
...
Q9. write a query to return customer name, artist name and total spent
